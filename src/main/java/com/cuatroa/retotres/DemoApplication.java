...
public class DemoApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
       ...
       SimpleDateFormat ft = new SimpleDateFormat("yyyy-MM-dd");
        ...
        crudRepository.saveAll(List.of(new Vegetarian("AP-903", "NEXT FOOD", "SUPLEMENTOS", "DESCRIPCION DETALLADA", true, 120000, 10, "https://www.avasoluciones.com/uploads/2021/09/910-006127.jpg"),
                new Vegetarian("AP-904", "KRIMA", "SOYA","DESCRIPCION DETALLADA",  true, 130000, 10, "https://www.avasoluciones.com/uploads/2021/09/910-007.jpg")
        ));
